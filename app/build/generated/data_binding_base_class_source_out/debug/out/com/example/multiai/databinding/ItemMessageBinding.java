...
public final class ItemMessageBinding implements ViewBinding {
  ...
  private ItemMessageBinding(@NonNull LinearLayout rootView, @NonNull MaterialCardView messageCard,
  ...
  public static ItemMessageBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemMessageBinding((LinearLayout) rootView, messageCard, messageText);
    }
